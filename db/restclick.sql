...
364	1	2021-9/1632527188680_500.jpg	4
...
18	customer-common	17
16	customer-home	18
17	customer-menu	19
19	customer-cart	20
20	customer-invoice	21
...
292	21	111	hall2	\N
288	21	111	hall	\N
290	21	112	customer-comment	\N
291	21	113	employee-comment	\N
...
296	21	117	serving	\N
297	21	118	subtotal	\N
305	21	119	total	\N
298	21	120	accept-conflict	\N
299	21	121	no	\N
302	21	122	completed	\N
303	21	123	payment	\N
304	21	124	discount	\N
...
SELECT pg_catalog.setval('"default".vne_order_product_ingredients_id_seq', 309, true);
...
SELECT pg_catalog.setval('"default".vne_order_products_id_seq', 111, true);
...
SELECT pg_catalog.setval('"default".vne_orders_id_seq', 45, true);
...
SELECT pg_catalog.setval('"default".vne_products_id_seq', 195, true);
...
SELECT pg_catalog.setval('"default".vne_word_translations_id_seq', 1016, true);
...
SELECT pg_catalog.setval('"default".vne_wordbooks_id_seq', 21, true);
...
SELECT pg_catalog.setval('"default".vne_words_id_seq', 314, true);
